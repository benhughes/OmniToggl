...
class TogglClient {
  ...
  async makeTogglRequest(url, options = {}) {
  ...
  async startTogglTimer(timeEntry) {
  ...
  async createTogglProject(name, cid = null) {
    const bodyData = Data.fromString(
  ...
  async createTogglClient(name, wid) {
